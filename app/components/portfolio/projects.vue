...
const projects: Project[] = [
  ...
  },
  {
    key: "crawler-2025-04",
    link:
      "https://github.com/pan93412?tab=repositories&q=nkust-crawler&type=source&language=&sort=",
  },
  {
    key: "yolo-rs-2024-12",
...
<template>
  <AppArticleBlock>
    ...
    <i18n-t keypath="projects.description" tag="p" scope="global">
      <template #my-github>
        <NuxtLink href="https://github.com/pan93412">{{
          $t("projects.my-github")
        }}</NuxtLink>
      </template>
      <template #blog>
        <NuxtLink href="https://blog.pan93.com">{{
          $t("projects.blog")
        }}</NuxtLink>
      </template>
    </i18n-t>
