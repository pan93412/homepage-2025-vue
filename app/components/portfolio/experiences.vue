...
import { defineComponent, type FunctionalComponent, h } from "vue";
...
interface ExperienceItem {
  ...
  contributions?:
    (ExperienceContributionItem | SimpleExperienceContributionItem)[];
}
    ...
    return () => {
      switch (props.contributionItem.type) {
        case "complete":
          return h(I18nT, {
            keypath:
              `experiences.${props.experienceKey}.contributions.${props.contributionItem.key}.description`,
            tag: "span",
            scope: "global",
        ...
        case "simple":
          return h(I18nT, {
            keypath:
              `experiences.${props.experienceKey}.contributions.${props.contributionItem.key}`,
            tag: "span",
            scope: "global",
          }, props.contributionItem.slots);
        default:
  ...
  <AppArticleBlock>
    ...
    >
      ...
      <p>
        ...
        <NuxtLink
          v-if="experience.moreInformationLink"
          :href="experience.moreInformationLink"
          class="text-blue-500"
        ...
        >
          ...
          >
            <template v-if="contribution.type === 'complete'">
              ...
              </strong>{{ $t("description-list.colon") }}<ContributionItem
